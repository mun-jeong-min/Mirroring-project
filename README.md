...
```
cd existing_repo
git remote add origin https://gitlab.com/moondeve41/company-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/moondeve41/company-project/-/settings/integrations)
